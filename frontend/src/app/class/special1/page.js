      ...
      <div className={styles.classContainer}>
        ...
        <div className={styles.teacherCard}>
          <div className={`${styles.teacherImage} teacherCard-item`}>
            <img src="/teacherProfile/special1.png" alt="ballet" />
          </div>
          <div className={`${styles.teacherInfo} teacherCard-item`}>
            <p className={styles.teacherName}><span className={`${styles.tag} ${styles.balletTag}`}>현대무용</span>김혜현</p>
        ...
        <div className={styles.classDetail}>
          ...
          <div className={styles.classBasicInfo}>
            ...
            <div className={styles.classHead}>
              ...
              <p style={{color:'#7E3B98'}}>* 본 클래스에 김혜현 강사님은 월 1~2회 참석하시며, 일정은 확정시 사전 안내드립니다.</p>
            </div>
