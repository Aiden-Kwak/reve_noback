...
const qnaList = [
  ...
  },
  {
    ...
    answer: "새로운 달의 시작 4일 전까지는 전액 환불, 3일 전까지는 50% 환불이 가능하며 2일 전부터는 환불이 불가합니다. 만약 고정 날짜에 참여하시지 못한다면, 부여된 체험권을 통해 날짜와 시간 이동이 가능하니 알뜰하게 사용해주세요. 주 1회 수강권은 월 1회, 주 2회 수강권은 월 2회 이내로 장르, 요일, 시간 변경 가능합니다.",
  },
  {
